...
WANTED = {
    ...
    # 目錄一律印在資產負債表之前，且只有 1-2 頁（見 p3、p3-4），成本極低。
    # 加這一節是為了跨學年度比對簽證會計師事務所是否變更（典型紅旗，
    # 見 docs/research/02-forensic-signals.md §7）——這個訊號需要事務所
    # 名稱本身，而目錄之外沒有其他章節會提到它。
    "會計師查核報告": "簽證會計師事務所與姓名——跨學年度比對是否換所",
}
